        ...
        <script type="text/javascript">
			function navigate(url, element) {
                ...
                fetch(url).then(response => {
                    ...
                    const extractedPart = tempDiv.querySelector('#partial').innerHTML;

                    document.getElementById('content').innerHTML = extractedPart;
			...
			function setActiveLink(activePage) {
				...
				navLinks.forEach(link => {
					...
					const icon = link.querySelector('i'); // Select the icon in the link
