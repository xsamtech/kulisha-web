								...
								<div class="d-flex align-items-center justify-content-between">
									...
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="cardFeedAction">
											...
											<li>
												<a class="dropdown-item" href="#"><i class="fa-regular fa-bell-slash fa-fw me-2"></i>@lang('miscellaneous.public.home.posts.actions.disable_notification')</a>
											</li>
		...
		@endforeach
									...
									<li class="nav-item">
										<a class="nav-link mb-0">
											<i class="bi bi-chat-fill pe-1"></i>@lang('miscellaneous.public.home.comments') (12)
										</a>
									</li>
									<!-- Card share action menu START -->
									<li class="nav-item dropdown">
										<a href="#" class="nav-link mb-0" id="cardShareAction" data-bs-toggle="dropdown" aria-expanded="false">
											<i class="bi bi-reply-fill flip-horizontal ps-1"></i>@lang('miscellaneous.share') (3)
										</a>
										<!-- Card share action dropdown menu -->
										<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="cardShareAction">
											<li>
												<a class="dropdown-item" href="#"><i class="bi bi-envelope fa-fw pe-2"></i>@lang('miscellaneous.public.home.posts.actions.send_via_dm')</a>
											</li>
											<li>
												<a class="dropdown-item" href="#">
													<i class="bi bi-link fa-fw pe-2"></i>@lang('miscellaneous.public.home.posts.actions.copy_link')
												</a>
											</li>
											<li>
												<a class="dropdown-item" href="#">
													<i class="bi bi-share fa-fw pe-2"></i>@lang('miscellaneous.public.home.posts.actions.share_via_')
												</a>
											</li>
											<li><hr class="dropdown-divider"></li>
											<li>
												<a class="dropdown-item" href="#">
													<i class="bi bi-arrow-repeat fa-fw pe-2"></i>@lang('miscellaneous.public.home.posts.actions.share_directly')
												</a>
											</li>
											<li>
												<a class="dropdown-item" href="#">
													<i class="bi bi-pencil-square fa-fw pe-2"></i>@lang('miscellaneous.public.home.posts.actions.share_with_opinion')
												</a>
											</li>
										</ul>
									</li>
									...
									<li class="nav-item">
										<a class="nav-link mb-0" href="#!">
											<i class="bi bi-send-fill pe-1"></i>@lang('miscellaneous.send')
										</a>
									</li>
								</ul>
								<!-- Feed react START -->
								...
								<div class="d-flex mb-3">
									...
									<div class="avatar avatar-xs me-2">
										<a href="#!">
											<img class="avatar-img rounded-circle" src="assets/img/template/avatar/12.jpg" alt>
										</a>
									</div>
									<!-- Comment box  -->
									<form class="position-relative w-100">
										<textarea class="form-control pe-4 bg-light" data-autoresize rows="1" placeholder="@lang('miscellaneous.public.home.posts.comments.add')"></textarea>
										<!-- Emoji button -->
										<div class="position-absolute top-0 end-0">
											<button class="btn" type="button"><i class="bi bi-emoji-smile-fill text-warning"></i></button>
										</div>

										<button class="btn btn-sm btn-primary mb-0 rounded mt-2" type="submit">@lang('miscellaneous.send')</button>
									</form>
								</div>
										...
										<ul class="comment-item-nested list-unstyled">
											...
											<li class="comment-item">
												...
												<div class="d-flex">
													<!-- Avatar -->
													<div class="avatar avatar-xs">
														<a href="#!"><img class="avatar-img rounded-circle" src="assets/img/template/avatar/06.jpg" alt></a>
													</div>
											...
											<li class="comment-item">
												...
												<div class="d-flex">
													...
													<div class="avatar avatar-story avatar-xs">
														<a href="#!">
															<img class="avatar-img rounded-circle" src="assets/img/template/avatar/07.jpg" alt>
														</a>
													</div>
						...
						<div class="card">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<div class="avatar me-2">
									<a href="#!"> <img class="avatar-img rounded-circle" src="assets/img/template/logo/12.svg" alt> </a>
								</div>
								...
								<div>
									...
									<a href="#!" class="mb-0 text-body">
										Sponsored<i class="bi bi-info-circle ps-1" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="You're seeing this ad because your activity meets the intended audience of our site."></i>
									</a>
								</div>
							</div>
					...
					<div class="card-header border-0 pb-0">
						<div class="d-flex align-items-center justify-content-between">
							<div class="d-flex align-items-center">
								...
								<div class="avatar me-2">
									<a href="#">
										<img class="avatar-img rounded-circle" src="assets/img/template/avatar/04.jpg" alt>
									</a>
								</div>
								<!-- Info -->
								<div>
									...
									<div class="nav nav-divider">
										...
										<span class="nav-item small" data-bs-toggle="tooltip" data-bs-placement="top" title="Public">
					...
					<div class="card-body">
						...
						<div class="d-flex justify-content-between">
							<div class="row g-3">
								<div class="col-6">
									<!-- Grid img -->
									<a href="assets/img/template/post/1by1/03.jpg" data-glightbox data-gallery="image-popup">
										<img class="rounded img-fluid" src="assets/img/template/post/1by1/03.jpg" alt="Image">
									</a>
								</div>
								<div class="col-6">
									<!-- Grid img -->
									<a href="assets/img/template/post/3by2/01.jpg" data-glightbox data-gallery="image-popup">
										<img class="rounded img-fluid" src="assets/img/template/post/3by2/01.jpg" alt="Image">
									</a>
									<!-- Grid img -->
									...
									<a href="assets/img/template/post/3by2/02.jpg" data-glightbox data-gallery="image-popup">
										<img class="img-fluid opacity-50 rounded" src="assets/img/template/post/3by2/02.jpg" alt>
									</a>
								</div>
							</div>
						</div>
					...
					<ul class="nav nav-stack py-3 small">
						<li class="nav-item">
							<a class="nav-link active text-secondary" href="#!">
								<i class="bi bi-heart-fill me-1 icon-xs bg-danger text-white rounded-circle"></i> Louis, Billy and 126 others
							</a>
						</li>
