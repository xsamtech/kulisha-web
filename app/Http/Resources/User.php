...
class User extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'profile_photo_path' => !empty($this->profile_photo_path) ? getWebURL() . $this->profile_photo_path : getWebURL() . '/assets/img/avatar-' . $this->gender . '.svg',
            'cover_photo_path' => !empty($this->cover_photo_path) ? getWebURL() . $this->cover_photo_path : getWebURL() . '/assets/img/cover-' . $last_field->alias . '.svg',
            ...
            'last_login_at' => !empty($this->last_login_at) ? $this->last_login_at->format('Y-m-d H:i:s') : null,
